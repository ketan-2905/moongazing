            ...
            <AnimatePresence initial={false}>
              {openIndex === i && (
                <motion.div
                  ...
                  className="px-4 md:px-6 pb-4 md:pb-6 text-gray-400 text-base md:text-lg leading-relaxed border-t border-gray-700 overflow-hidden bg-gray-800/60 backdrop-blur-md shadow-md rounded-b-2xl"
                >
                  {faq.answer}
                </motion.div>
              )}
